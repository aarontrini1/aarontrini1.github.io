...
})({"4cCs7":[function(require,module,exports) {
...
function moveButton(button, event) {
    ...
    if (Math.random() < 0.50) randomX = randomX * -1;
    if (Math.random() < 0.50) randomY = randomY * -1;
    if (mouseX + randomX > maxX || mouseY + randomY > maxY) moveButton(button, event);
...
},{"bootstrap/dist/css/bootstrap.min.css":"i5LP7"}],"i5LP7":[function() {},{}]},["4cCs7","1Z4Rq"], "1Z4Rq", "parcelRequiredd8f")
